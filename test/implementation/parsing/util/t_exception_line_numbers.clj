(ns implementation.parsing.util.t_exception_line_numbers
...
(capturing-failure-output
 ...
 (fact
   ...
   @fact-output => #"t_exception_line_numbers.clj:8"))
...
(capturing-failure-output ;; Reports on outer-level fact
 ...
 (fact
   ...
   @fact-output => #"t_exception_line_numbers.clj:15"))
...
(capturing-failure-output
 ...
 (fact
   ...
   @fact-output => #"t_exception_line_numbers.clj:21"))
